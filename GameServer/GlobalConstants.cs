...
namespace DOL.GS
{
    ...
    public enum eCharacterClass : byte
    {
        ...
        WraithSummonerMid = 76,
        WraithSummonerHib = 77,
        CorsairAlb = 78,
        CorsairMid = 79,
        CorsairHib = 80,
        DragoonAlb = 81,
        ...
        ChaosMageMid = 97,
        ChaosMageHib = 98,
        ElementalKnightAlb = 99,
        ElementalKnightMid = 100,
        ElementalKnightHib = 101,
    }
    ...
    public static class GlobalConstants
    {
        ...
        public static readonly Dictionary<eRealm, List<eCharacterClass>> STARTING_CLASSES_DICT = new Dictionary<eRealm, List<eCharacterClass>>()
        {
            ...
            {eRealm.Albion, new List<eCharacterClass>() {eCharacterClass.Fighter, eCharacterClass.Acolyte, eCharacterClass.Mage, eCharacterClass.Elementalist, eCharacterClass.AlbionRogue, eCharacterClass.Disciple,
                ...
                eCharacterClass.BlueMageAlb,	// BlueMage_Alb = 63,
                eCharacterClass.RedMageAlb,		// RedMage_Alb = 66,
                eCharacterClass.GeomancerAlb,		// Geomancer_Alb = 69,
                eCharacterClass.ReaperAlb,		// Reaper_Alb = 72,
                eCharacterClass.WraithSummonerAlb,		// WraithSummoner_Alb = 75,
                eCharacterClass.CorsairAlb,		// Corsair_Alb = 78,
                eCharacterClass.DragoonAlb,		// Dragoon_Alb = 81,
                eCharacterClass.PuppetMasterAlb,		// PuppetMaster_Alb = 84,
                eCharacterClass.DarkKnightAlb,		// DarkKnight_Alb = 87,
                eCharacterClass.AlchemistAlb,		// Alchemist_Alb = 90,
                eCharacterClass.PsionAlb,		// Psion_Alb = 93,
                eCharacterClass.ChaosMageAlb,		// ChaosMage_Alb = 96,
                eCharacterClass.ElementalKnightAlb		// ElementalKnight_Alb = 99,
            }},
            {eRealm.Midgard, new List<eCharacterClass>() {eCharacterClass.Viking, eCharacterClass.Mystic, eCharacterClass.Seer, eCharacterClass.MidgardRogue,
                ...
                eCharacterClass.BlueMageMid,	// BlueMage_Mid = 64,
                eCharacterClass.RedMageMid,		// RedMage_Mid = 67,
                eCharacterClass.GeomancerMid,		// Geomancer_Mid = 70,
                eCharacterClass.ReaperMid,		// Reaper_Mid = 73,
                eCharacterClass.WraithSummonerMid,		// WraithSummoner_Mid = 76,
                eCharacterClass.CorsairMid,		// Corsair_Mid = 79,
                eCharacterClass.DragoonMid,		// Dragoon_Mid = 82,
                eCharacterClass.PuppetMasterMid,		// PuppetMaster_Mid = 85,
                eCharacterClass.DarkKnightMid,		// DarkKnight_Mid = 88,
                eCharacterClass.AlchemistMid,		// Alchemist_Mid = 91,
                eCharacterClass.PsionMid,		// Psion_Mid = 94,
                eCharacterClass.ChaosMageMid,		// ChaosMage_Mid = 97,
                eCharacterClass.ElementalKnightMid		// ElementalKnight_Mid = 100,
            }},
            {eRealm.Hibernia, new List<eCharacterClass>() {eCharacterClass.Guardian, eCharacterClass.Stalker, eCharacterClass.Naturalist, eCharacterClass.Magician, eCharacterClass.Forester,
                ...
                eCharacterClass.BlueMageHib,	// BlueMage_Hib = 65,
                eCharacterClass.RedMageHib,		// RedMage_Hib = 68,
                eCharacterClass.GeomancerHib,		// Geomancer_Hib = 71,
                eCharacterClass.ReaperHib,		// Reaper_Hib = 74,
                eCharacterClass.WraithSummonerHib,		// WraithSummoner_Hib = 77,
                eCharacterClass.CorsairHib,		// Corsair_Hib = 80,
                eCharacterClass.DragoonHib,		// Dragoon_Hib = 83,
                eCharacterClass.PuppetMasterHib,		// PuppetMaster_Hib = 86,
                eCharacterClass.DarkKnightHib,		// DarkKnight_Hib = 89,
                eCharacterClass.AlchemistHib,		// Alchemist_Hib = 92,
                eCharacterClass.PsionHib,		// Psion_Hib = 95,
                eCharacterClass.ChaosMageHib,		// ChaosMage_Hib = 98,
                eCharacterClass.ElementalKnightHib		// ElementalKnight_Hib = 101,
            }},
        };
