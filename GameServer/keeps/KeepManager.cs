...
namespace DOL.GS.Keeps
{
    ...
    public class DefaultKeepManager : IKeepManager
    {
        ...
        public virtual IEnumerable GetKeepsCloseToSpot(ushort regionid, System.Numerics.Vector3 point3d, int radius)
            => GetKeepsCloseToSpot(regionid, point3d.X, point3d.Y, point3d.Z, radius);

        [Obsolete("Use .GetKeepCloseToSpot(Position, int) instead!")]
        public virtual AbstractGameKeep GetKeepCloseToSpot(ushort regionid, System.Numerics.Vector3 point3d, int radius) 
            => GetKeepCloseToSpot(Position.Create(regionid, Coordinate.Create((int)point3d.X, (int)point3d.Y, (int)point3d.Y)), radius);
