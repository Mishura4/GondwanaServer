...
namespace DOL.GS.Spells
{
    ...
    public abstract class SummonSpellHandler : SpellHandler
    {
        ...
        public override void FinishSpellCast(GameLiving target)
        {
            ...
            {
                if (player != m_caster)
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "GameObject.Casting.CastsASpell", player.GetPersonalizedName(m_caster)), eChatType.CT_Spell, eChatLoc.CL_SystemWindow);
            }
        ...
        public override string GetDelveDescription(GameClient delveClient)
        {
            ...
            string mainDesc = LanguageMgr.GetTranslation(delveClient, "SpellDescription.SummonSpell.MainDescription", Math.Abs(Spell.Damage), Spell.Value);
