    ...
    public class SiegeDirectDamageSpellHandler : DirectDamageSpellHandler
    {
        ...
        public override void SendDamageMessages(AttackData ad)
        {
            ...
            if (Caster is GameSiegeWeapon)
            {
                ...
                if (siege.Owner != null)
                {
                    siege.Owner.SendMessage(string.Format("You hit {0} for {1}{2} damage!", ad.Target.GetName(0, false), ad.Damage, modmessage), eChatType.CT_YouHit, eChatLoc.CL_SystemWindow);
                }
            }
        }
