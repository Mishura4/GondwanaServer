...
namespace DOL.GS.Commands
{
	...
	public class BountyRentCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		public void OnCommand(GameClient client, string[] args)
		{
            ...
            if (args.Length < 3)
            {
                client.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "Commands.Players.Bountyrent.CorrectFormat"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
				...
				case "personal":
					{
                        ...
                        {
                            client.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "Commands.Players.Bountyrent.AlreadyMaxMoney"),
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        ...
                        {
                            client.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "Commands.Players.Bountyrent.ToManyMoney"),
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
				...
				case "guild":
					{
                        if (house.DatabaseItem.GuildHouse && client.Player.GuildName == house.DatabaseItem.GuildName)
                        {
                            if (house.CanPayRent(client.Player))
                            {
                                ...
                                {
                                    client.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "Commands.Players.Bountyrent.NotEnoughGuildBp"),
                                        eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                    return;
                                }
                                ...
                                client.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "Commands.Players.Bountyrent.YouSpendGuild", BPsToAdd, ((BPsToAdd * bpWorth) / bpWorth)),
                                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
