...
namespace DOL.GS.Commands
{
    ...
    public class EmoteCommandHandler : AbstractCommandHandler, ICommandHandler
    {
        ...
        public void OnCommand(GameClient client, string[] args)
        {
            ...
            {
                DisplayMessage(client, LanguageMgr.GetTranslation(client, "Commands.Players.Emotes.Dead"));
                return;
            }
            ...
            {
                DisplayMessage(client, LanguageMgr.GetTranslation(client, "Commands.Players.Emotes.Busy"));
                return;
            }

            if (client.Player.IsMuted)
            {
                client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client, "Commands.Players.Emotes.Muted"), eChatType.CT_Staff, eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            if (client.Player.TargetObject != null)
            {
                ...
                {
                    DisplayMessage(client, LanguageMgr.GetTranslation(client, "Commands.Players.Emotes.Target"));
                    return;
                }
            }
            ...
            {
                string message = LanguageMgr.GetTranslation(client, "Commands.Players.Emotes.Message" + Util.Random(1, 4).ToString());
