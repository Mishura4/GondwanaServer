...
namespace DOL.GS.Trainer
{
    ...
    public class SorcererTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID2 = "journeymans_robe2";
        public const string ARMOR_ID3 = "befuddlers_robe_alb";
        public const string ARMOR_ID4 = "charmers_robe_alb";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "SorcererTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "SorcererTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            switch (text)
            {
                ...
                case "l'Académie":
                    ...
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Sorcerer, LanguageMgr.GetTranslation(player.Client.Account.Language, "SorcererTrainer.Interact.Text4", player.GetName(0, false)), null);
