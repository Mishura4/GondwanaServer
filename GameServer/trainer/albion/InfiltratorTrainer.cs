...
namespace DOL.GS.Trainer
{
    ...
    public class InfiltratorTrainer : GameTrainer
    {
        ...
        public const string WEAPON_ID2 = "thrust_sword_item";
        public const string ARMOR_ID1 = "vest_of_the_initiate_alb";
        public const string ARMOR_ID2 = "vest_of_the_lurker_alb";
        public const string ARMOR_ID3 = "blue_hands_vest";
        public const string ARMOR_ID4 = "spys_vest";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "InfiltratorTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "InfiltratorTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            if (CanPromotePlayer(player))
            {
                switch (text)
                {
                    ...
                    case "thrusting":
                    case "perforante":
                        PromotePlayer(player, (int)eCharacterClass.Infiltrator, LanguageMgr.GetTranslation(player.Client.Account.Language, "InfiltratorTrainer.WhisperReceive.Text2", player.GetName(0, false)), null);
