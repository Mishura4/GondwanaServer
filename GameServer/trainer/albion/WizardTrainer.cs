...
namespace DOL.GS.Trainer
{
    ...
    public class WizardTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID2 = "adepts_robe_alb2";
        public const string ARMOR_ID3 = "elementalists_robe";
        public const string ARMOR_ID4 = "spellbinders_robe_alb";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "WizardTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "WizardTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            switch (text)
            {
                ...
                case "l'Académie":
                    ...
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Wizard, LanguageMgr.GetTranslation(player.Client.Account.Language, "WizardTrainer.Interact.Text4", player.GetName(0, false)), null);
