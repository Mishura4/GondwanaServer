...
namespace DOL.GS.Trainer
{
    ...
    public class HereticTrainer : GameTrainer
    {
        ...
        public const string WEAPON_ID2 = "reaver_item";
        public const string ARMOR_ID1 = "robes_of_the_novice_alb";
        public const string ARMOR_ID2 = "robe_of_the_apprentice_heretic";
        public const string ARMOR_ID3 = "robe_of_the_initiate_alb";
        public const string ARMOR_ID4 = "proselytes_robe_alb";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "HereticTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "HereticTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
