...
namespace DOL.GS.Trainer
{
    ...
    public class SkaldTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID2 = "chanters_vest";
        public const string ARMOR_ID3 = "song_weavers_vest";
        public const string ARMOR_ID4 = "saga_spinners_vest";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "SkaldTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "SkaldTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            if (CanPromotePlayer(player))
            {
                ...
                {
                    case "House of Bragi":
                    case "Panthéon de Bragi":
                        player!.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "SkaldTrainer.Interact.Text4", this.Name, player.GetName(0, false), player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
                        break;
