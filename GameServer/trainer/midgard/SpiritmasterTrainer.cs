...
namespace DOL.GS.Trainer
{
    ...
    public class SpiritmasterTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID2 = "practitioners_vest";
        public const string ARMOR_ID3 = "journeymans_vest_mid1";
        public const string ARMOR_ID4 = "summoners_vest_mid";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "SpiritmasterTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "SpiritmasterTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            switch (text)
            {
                ...
                case "Panthéon de Hel":
                    ...
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Spiritmaster, LanguageMgr.GetTranslation(player!.Client.Account.Language, "SpiritmasterTrainer.Interact.Text4", player.GetName(0, false)), null);
