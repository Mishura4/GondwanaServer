...
namespace DOL.GS.Trainer
{
    ...
    public class WarriorTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID2 = "yeomans_vest";
        public const string ARMOR_ID3 = "footmans_vest";
        public const string ARMOR_ID4 = "veterans_vest_mid";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "WarriorTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "WarriorTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            if (CanPromotePlayer(player))
            {
                ...
                {
                    case "House of Tyr":
                    case "Panthéon de Tyr":
                        player!.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "WarriorTrainer.Interact.Text4", this.Name, player.GetName(0, false), player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
                        break;
