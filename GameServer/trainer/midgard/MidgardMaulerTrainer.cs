...
namespace DOL.GS.Trainer
{
    ...
    public class MidgardMaulerTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID1 = "vest_of_the_novice_mid";
        public const string ARMOR_ID2 = "stoneskin_vest_mid";
        public const string ARMOR_ID3 = "vest_of_five_paws_mid";
        public const string ARMOR_ID4 = "vest_of_the_pugilist_mid";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "MaulerMidTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "MaulerMidTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
