...
namespace DOL.GS.Trainer
{
    ...
    public class RunemasterTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID2 = "runic_practitioners_vest";
        public const string ARMOR_ID3 = "runecarvers_vest";
        public const string ARMOR_ID4 = "stonetellers_vest";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "RunemasterTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "RunemasterTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            switch (text)
            {
                ...
                case "Panthéon d'Odin'":
                    ...
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Runemaster, LanguageMgr.GetTranslation(player!.Client.Account.Language, "RunemasterTrainer.Interact.Text4", player.GetName(0, false)), null);
