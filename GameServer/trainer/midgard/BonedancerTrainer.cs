...
namespace DOL.GS.Trainer
{
    ...
    public class BonedancerTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID1 = "vest_of_the_eleve_mid";
        public const string ARMOR_ID2 = "bonegatherers_vest";
        public const string ARMOR_ID3 = "tribals_vest_mid";
        public const string ARMOR_ID4 = "apprentices_vest_mid";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BonedancerTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BonedancerTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            switch (text)
            {
                case "House of Bodgar":
                case "Panthéon de Bogdar":
                    // promote player to other class
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Bonedancer, LanguageMgr.GetTranslation(player!.Client.Account.Language, "BonedancerTrainer.Interact.Text4", player.GetName(0, false)), null);
