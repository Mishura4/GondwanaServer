...
namespace DOL.GS.Trainer
{
    ...
    public class ShamanTrainer : GameTrainer
    {
        ...
        public const string WEAPON_ID = "shaman_item";
        public const string ARMOR_ID1 = "vest_of_the_seer_mid";
        public const string ARMOR_ID2 = "practitioners_vest3";
        public const string ARMOR_ID3 = "journeymans_vest_mid2";
        public const string ARMOR_ID4 = "medicines_vest_mid";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "ShamanTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "ShamanTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            {
                case "House of Ymir":
                case "Panthéon d'Ymir'":
                    // promote player to other class
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Shaman, LanguageMgr.GetTranslation(player.Client.Account.Language, "ShamanTrainer.Interact.Text4", player.GetName(0, false)), null);
