...
namespace DOL.GS.Trainer
{
    ...
    public class ShadowbladeTrainer : GameTrainer
    {
        ...
        public const string WEAPON_ID = "shadowblade_item";
        public const string ARMOR_ID1 = "vest_of_the_huntsman_mid";
        public const string ARMOR_ID2 = "dark_seekers_vest";
        public const string ARMOR_ID3 = "deceivers_vest_mid";
        public const string ARMOR_ID4 = "shadow_lurkers_vest";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "ShadowbladeTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "ShadowbladeTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            {
                case "House of Loki":
                case "Panthéon de Loki":
                    // promote player to other class
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Shadowblade, LanguageMgr.GetTranslation(player!.Client.Account.Language, "ShadowbladeTrainer.Interact.Text4", player.GetName(0, false)), null);
