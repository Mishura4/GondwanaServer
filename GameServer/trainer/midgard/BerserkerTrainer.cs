...
namespace DOL.GS.Trainer
{
    ...
    public class BerserkerTrainer : GameTrainer
    {
        ...
        public const string WEAPON_ID4 = "leftaxe_mid_item";
        public const string ARMOR_ID1 = "vest_of_the_huntsman_mid2";
        public const string ARMOR_ID2 = "seekers_vest";
        public const string ARMOR_ID3 = "fervents_vest_mid";
        public const string ARMOR_ID4 = "pillagers_vest2";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BerserkerTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BerserkerTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
            ...
            if (CanPromotePlayer(player))
            {
                switch (text)
                {
                    ...
                    case "hache main gauche":
                        PromotePlayer(player, (int)eCharacterClass.Berserker, LanguageMgr.GetTranslation(player.Client.Account.Language, "BerserkerTrainer.WhisperReceive.Text5", player.GetName(0, false)), null);
