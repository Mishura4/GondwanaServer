...
namespace DOL.GS.Trainer
{
    ...
    public class DruidTrainer : GameTrainer
    {
        ...
        public const string WEAPON_ID1 = "druid_item";
        // public const string ARMOR_ID0 = "druid_armor";
        public const string ARMOR_ID1 = "vest_of_the_novice_hib";
        public const string ARMOR_ID2 = "students_vest_hib";
        public const string ARMOR_ID3 = "apprentices_vest_hib";
        public const string ARMOR_ID4 = "grove_healer_hauberk_hib";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "DruidTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "DruidTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            switch (text)
            {
                ...
                case "Voie de l'Harmonie":
                    ...
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Druid, LanguageMgr.GetTranslation(player!.Client.Account.Language, "DruidTrainer.Interact.Text4", player.GetName(0, false)), null);
