...
namespace DOL.GS.Trainer
{
    ...
    public class AnimistTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID2 = "apprentices_robe_hib";
        public const string ARMOR_ID3 = "friend_of_gaias_robe_hib";
        public const string ARMOR_ID4 = "plantfriends_robe_hib";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "AnimistTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "AnimistTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            switch (text)
            {
                ...
                case "Voie de l'Affinité":
                    ...
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Animist, LanguageMgr.GetTranslation(player.Client.Account.Language, "AnimistTrainer.Interact.Text4", player.GetName(0, false)), null);
