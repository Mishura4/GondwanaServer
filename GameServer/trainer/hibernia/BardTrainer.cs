...
namespace DOL.GS.Trainer
{
    ...
    public class BardTrainer : GameTrainer
    {
        ...
        public const string ARMOR_ID1 = "vest_of_the_chanter_hib";
        public const string ARMOR_ID2 = "vocalists_vest";
        public const string ARMOR_ID3 = "carolers_vest";
        public const string ARMOR_ID4 = "choralists_vest";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BardTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BardTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
        ...
        public override bool WhisperReceive(GameLiving source, string text)
        {
            ...
            switch (text)
            {
                ...
                case "Voie de l'Essence":
                    ...
                    if (CanPromotePlayer(player))
                    {
                        PromotePlayer(player, (int)eCharacterClass.Bard, LanguageMgr.GetTranslation(player.Client.Account.Language, "BardTrainer.Interact.Text4", player.GetName(0, false)), null);
