...
namespace DOL.GS.Trainer
{
    ...
    public class HeroTrainer : GameTrainer
    {
        ...
        //public const string ARMOR_ID1 = "hero_armor";
        public const string WEAPON_ID1 = "blunt_hib_item";
        public const string WEAPON_ID2 = "blades_hib_item";
        public const string WEAPON_ID3 = "piercing_hib_item";
        public const string WEAPON_ID4 = "largeweap_hib_item";
        public const string WEAPON_ID5 = "celticspear_hib_item";
        public const string ARMOR_ID1 = "vest_of_the_neophyte_hib";
        public const string ARMOR_ID2 = "servitors_vest";
        public const string ARMOR_ID3 = "confidants_vest_hib";
        public const string ARMOR_ID4 = "henchmans_vest_hib";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "HeroTrainer.Interact.Text3", this.Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "HeroTrainer.Interact.Text1", this.Name, player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
            ...
            if (CanPromotePlayer(player))
            {
                switch (text)
                {
                    ...
                    case "Voie des Anciens":
                        player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "HeroTrainer.Interact.Text4", this.Name, player.GetName(0, false), player.CharacterClass.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
                        break;
