...
namespace DOL.Integration.Database
{
    ...
    public class DatabaseTests
    {
        ...
        public void TestTablePrimaryKeyWithPrecache()
        {
            ...
            // Insert some Object
            var obj = new TestTablePrecachedPrimaryKey
            {
                TestField = "Test For Precached Table with Primary Key",
                PrecachedValue = "Some Value for Precache Table With Primary Key",
