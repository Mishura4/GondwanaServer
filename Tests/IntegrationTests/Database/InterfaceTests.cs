...
namespace DOL.Integration.Database
{
    ...
    public class InterfaceTests
    {
        ...
        public void TestMultipleFindObjectByKeyPrimaryKey()
        {
            ...
            var objs = Enumerable.Range(0, 10).Select(i => new TestTablePrimaryKey
            {
                PrimaryKey = DOL.Database.UniqueID.IDGenerator.GenerateID(),
                TestField = string.Format("Test For Multiple Find Objects By Key #{0}", i)
            }).ToArray();
